...
urlpatterns = [
    ...
    re_path( r'^env/', include('jt.environment.urls' )),
    re_path( r'^user/', include('jt.apps.user.urls' )),
    re_path( r'^config/', include('jt.apps.config.urls' )),
    re_path( r'^notify/', include('jt.apps.notify.urls' )),
    re_path( r'^system/', include('jt.apps.system.urls' )),
...
handler404 = 'jt.views.custom_404_handler'


if settings.DEBUG:
    urlpatterns += [
        re_path( r'^testing/', include('jt.testing.urls' )),
    ]
