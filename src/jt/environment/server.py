...
class EnvironmentSettings:
    ...
    def get( cls ) -> 'EnvironmentSettings':
        ...
        try:
            ...
            pass
        # Read version from JT_VERSION file (single source of truth)
        version_file_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'JT_VERSION')
        try:
        ...
        try:
            env_settings.REDIS_PORT = int( cls.get_env_variable('JT_REDIS_PORT') )
        except ( TypeError, ValueError ):
            pass
        ...
        extra_host_urls_str = cls.get_env_variable( 'JT_EXTRA_HOST_URLS', '' )
        ...
        extra_csp_urls_str = cls.get_env_variable( 'JT_EXTRA_CSP_URLS', '' )
