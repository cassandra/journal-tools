"""
Django settings for Journal Tools project.
...
from jt.environment.server import EnvironmentSettings
...
MIDDLEWARE = [
    ...
    'jt.middleware.ExceptionMiddleware',
    'jt.middleware.ViewMiddleware',
    'jt.apps.user.middleware.AuthenticationMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'jt.context_processors.constants_context',
                'jt.environment.context_processors.client_config',
                'jt.apps.config.context_processors.settings_context',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join( ENV.DATABASES_NAME_PATH, 'jt.sqlite3' ),
    }
}
