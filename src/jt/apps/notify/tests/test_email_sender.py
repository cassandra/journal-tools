...
from jt.apps.notify.email_sender import EmailData, EmailSender, UnsubscribedEmailError
from jt.apps.notify.models import UnsubscribedEmail
...
class TestEmailSender(BaseTestCase):
    ...
    @patch('jt.apps.notify.email_sender.send_html_email')
