...
from jt.constants import TIMEZONE_NAME_LIST
from jt.apps.console.enums import Theme, DisplayUnits
...
class PredefinedValueRanges:
    ...
    TIMEZONE_CHOICES_ID = 'jt.timezone'
    UNITS_CHOICES_ID = 'jt.units'
    THEME_CHOICES_ID = 'jt.theme'
