...
from jt.apps.attribute.value_ranges import PredefinedValueRanges
from jt.testing.base_test_case import BaseTestCase
...
class TestPredefinedValueRanges(BaseTestCase):
    ...
    @patch('jt.apps.attribute.value_ranges.TIMEZONE_NAME_LIST')
    ...
    def test_predefined_value_ranges_id_constants_immutability(self):
        ...
        self.assertEqual(PredefinedValueRanges.TIMEZONE_CHOICES_ID, 'jt.timezone')
        self.assertEqual(PredefinedValueRanges.UNITS_CHOICES_ID, 'jt.units')
        self.assertEqual(PredefinedValueRanges.THEME_CHOICES_ID, 'jt.theme')
        return

    @patch('jt.apps.attribute.value_ranges.DisplayUnits')
    @patch('jt.apps.attribute.value_ranges.Theme')
