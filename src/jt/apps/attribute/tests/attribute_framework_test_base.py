...
from jt.testing.base_test_case import MockRequest, MockSession
from jt.apps.attribute.edit_context import AttributeItemEditContext
from jt.apps.attribute.edit_form_handler import AttributeEditFormHandler
from jt.apps.attribute.edit_response_renderer import AttributeEditResponseRenderer
from jt.apps.attribute.edit_template_context_builder import AttributeEditTemplateContextBuilder
from jt.apps.attribute.models import AttributeModel
from jt.apps.attribute.enums import AttributeType, AttributeValueType
...
class AttributeEditFormHandlerTestMixin(AttributeFrameworkTestMixin, ABC):
    ...
    def test_file_deletion_workflow(self):
        ...
        from jt.constants import DIVID
        query_dict = QueryDict(mutable=True)
