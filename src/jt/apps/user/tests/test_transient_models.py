...
from jt.apps.user.transient_models import UserAuthenticationData
...
class TestUserAuthenticationData(BaseTestCase):
    ...
    @patch('jt.apps.user.transient_models.MagicCodeGenerator')
    @patch('jt.apps.user.transient_models.PasswordResetTokenGenerator')
    ...
    @patch('jt.apps.user.transient_models.forms.SigninMagicCodeForm')
    @patch('jt.apps.user.transient_models.MagicCodeGenerator')
    @patch('jt.apps.user.transient_models.PasswordResetTokenGenerator')
