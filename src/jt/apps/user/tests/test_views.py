...
from jt.apps.notify.email_sender import EmailSender
from jt.apps.user.magic_code_generator import MagicCodeStatus, MagicCodeGenerator
from jt.apps.user.signin_manager import SigninManager
from jt.testing.view_test_base import SyncViewTestCase
...
class TestUserSigninView(SyncViewTestCase):
    ...
    @patch('jt.apps.user.views.SendMagicLinkEmailView')
    ...
    @patch('jt.apps.user.views.SigninMagicCodeView')
...
class TestSendMagicLinkEmailView(SyncViewTestCase):
    ...
    def test_send_signin_magic_link(self, mock_magic_code_view_class, mock_send_email):
        ...
        from jt.apps.user.views import SendMagicLinkEmailView
...
class TestSigninMagicCodeView(SyncViewTestCase):
    ...
    def test_get_response_method(self):
        ...
        from jt.apps.user.views import SigninMagicCodeView
        from jt.apps.user.forms import SigninMagicCodeForm
    ...
    @patch.object(MagicCodeGenerator, 'check_magic_code')
    @patch('jt.apps.user.forms.SigninMagicCodeForm')
