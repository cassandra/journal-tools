...
from jt.apps.user.magic_code_generator import MagicCodeGenerator, MagicCodeStatus
...
class TestMagicCodeGenerator(BaseTestCase):
    ...
    @patch('jt.apps.user.magic_code_generator.MagicCodeGenerator.get_elapsed_seconds')
