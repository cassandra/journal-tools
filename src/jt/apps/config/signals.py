...
from jt.apps.common.module_utils import import_module_safe
from jt.apps.config.app_settings import AppSettings
...
class SettingsInitializer:
    ...
    def _discover_app_settings( self ) -> List[ AppSettings ]:
        ...
        for app_config in apps.get_app_configs():
            if not app_config.name.startswith( 'jt' ):
                continue
    ...
    def _create_app_subsystem_if_needed( self, app_settings ):
        from jt.apps.config.models import Subsystem
    ...
    def _create_setting_attribute_if_needed( self,
                                             ...
                                             setting_key,
                                             setting_definition ):
        from jt.apps.attribute.enums import AttributeType
        from jt.apps.config.models import SubsystemAttribute
