/*
 * Journal Tools - Attribute Dirty State Tracking
...
(function() {
    ...
    function DirtyTracker(containerId) {
        ...
        this.config = {
            formSelector: Jt.ATTR_V2_FORM_CLASS_SELECTOR,
            messageContainerSelector: Jt.ATTR_V2_DIRTY_MESSAGE_SELECTOR,
    ...
    DirtyTracker.prototype = {
        ...
        captureOriginalValues: function() {
            ...
            const attributeFields = form.querySelectorAll(`${Jt.ATTR_V2_ATTRIBUTE_CARD_SELECTOR} input, ${Jt.ATTR_V2_ATTRIBUTE_CARD_SELECTOR} textarea, ${Jt.ATTR_V2_ATTRIBUTE_CARD_SELECTOR} select`);
            ...
            const fileTitleFields = form.querySelectorAll(Jt.ATTR_V2_FILE_TITLE_INPUT_SELECTOR);
        ...
        hasFieldChanged: function(field) {
            ...
            const isNewAttributeField = field.closest(Jt.ATTR_V2_NEW_ATTRIBUTE_SELECTOR);
        ...
        bindEvents: function() {
            ...
            $container.on('focus.dirty-tracking', '.' + Jt.ATTR_V2_FILE_TITLE_INPUT_CLASS, (e) => {
        ...
        markFieldDirty: function(field) {
            ...
            if (field.classList.contains(Jt.ATTR_V2_FILE_TITLE_INPUT_CLASS)) {
        ...
        getFieldContainer: function(field) {
            ...
            if (field.classList.contains(Jt.ATTR_V2_FILE_TITLE_INPUT_CLASS)) {
                const fileInfo = field.closest(Jt.ATTR_V2_FILE_INFO_SELECTOR);
                if (fileInfo) {
            ...
            const attributeCard = field.closest(Jt.ATTR_V2_ATTRIBUTE_CARD_SELECTOR);
            if (attributeCard) {
                return attributeCard.querySelector(Jt.ATTR_V2_ATTRIBUTE_NAME_SELECTOR);
            }
        ...
        insertDirtyIndicator: function(container, indicator) {
            ...
            if (container.classList.contains(Jt.ATTR_V2_ATTRIBUTE_NAME_CLASS)) {
        ...
        updateMessageArea: function() {
            ...
            if (dirtyCount === 0) {
                ...
                messageContainer.className = Jt.ATTR_V2_DIRTY_MESSAGE_CLASS;
            } else {
                ...
                messageContainer.className = `${Jt.ATTR_V2_DIRTY_MESSAGE_CLASS} active`;
            }
        ...
        updateButtonProminence: function(isDirty) {
            const $updateButton = $(this.container).find(Jt.ATTR_V2_UPDATE_BTN_SELECTOR);
        ...
        syncDisplayToHiddenFields: function() {
            ...
            const displayFields = form.querySelectorAll(Jt.ATTR_V2_DISPLAY_FIELD_SELECTOR);
    ...
    const JtAttrDirtyTracking = {
        ...
        initializeAll: function() {
            const containers = document.querySelectorAll(Jt.ATTR_V2_CONTAINER_SELECTOR);
        ...
        handleFormSuccess: function(event) {
            const form = event.target.closest(Jt.ATTR_V2_FORM_CLASS_SELECTOR);
            if (form) {
    ...
    window.Jt.attr.dirtyTracking = JtAttrDirtyTracking;
    
    // Auto-initialize when DOM is ready
    document.addEventListener('DOMContentLoaded', function() {
        JtAttrDirtyTracking.init();
    });
